    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden mb-12">
      <div className="px-4 sm:px-6 py-4 sm:py-5 border-b border-gray-100 bg-gray-50/50">
        <div className="flex items-center gap-2 mb-1">
          <Gift className="text-brand-slate flex-shrink-0" size={20} />
          <h2 className="text-base sm:text-lg font-bold text-brand-slate">Controle do Catálogo de Recompensas</h2>
        </div>
        ...
        <table className="w-full text-left border-collapse min-w-[440px]">
          <thead>
            <tr className="bg-white text-brand-text text-xs uppercase tracking-wider border-b border-gray-100">
              ...
              <th className="px-3 sm:px-6 py-3 font-semibold text-right whitespace-nowrap">Ativo</th>
            </tr>
          </thead>
            ...
            {items.map((item) => (
              ...
              >
                <td className="px-4 sm:px-6 py-4">
                  <div className="font-bold text-brand-slate text-sm sm:text-base">{item.title}</div>
                  <div className="text-xs font-semibold text-brand-text mt-1 uppercase tracking-wide">
                    {item.partner}
                  </div>
                </td>
                <td className="px-3 sm:px-6 py-4 text-center font-bold text-emerald-600 whitespace-nowrap">{item.points} pts</td>
