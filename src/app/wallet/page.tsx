...
function computeLevel(points: number) {
  if (points >= 5000) return { currentLevel: 'Especialista', nextLevel: 'Mestre', levelProgress: Math.min(100, ((points - 5000) / 5000) * 100) };
  if (points >= 2000) return { currentLevel: 'Analista Sênior', nextLevel: 'Especialista', levelProgress: ((points - 2000) / 3000) * 100 };
  if (points >= 500) return { currentLevel: 'Analista', nextLevel: 'Analista Sênior', levelProgress: ((points - 500) / 1500) * 100 };
    ...
    <main className="pb-20 pt-8">
      <div className="max-w-[1000px] mx-auto px-6 md:px-8">
        ...
        {isLoading ? (
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-8 text-center text-brand-text">
